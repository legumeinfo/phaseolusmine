...
public class ConsensusRegionShadow implements ConsensusRegion, ShadowClass
{
    public static final Class<ConsensusRegion> shadowOf = ConsensusRegion.class;
    // Attr: org.intermine.model.bio.ConsensusRegion.length
    ...
    // Ref: org.intermine.model.bio.ConsensusRegion.sequenceOntologyTerm
    ...
    // Ref: org.intermine.model.bio.ConsensusRegion.geneFamily
    ...
    // Ref: org.intermine.model.bio.ConsensusRegion.sequence
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.ConsensusRegion.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ConsensusRegion.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ConsensusRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ConsensusRegionShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.ConsensusRegion");
        if (length != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ConsensusRegionShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ConsensusRegion)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ConsensusRegion.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ConsensusRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
