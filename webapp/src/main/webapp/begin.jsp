...
<div id="content-wrap">
    ...
    <div id="bottom-wrap">
        ...
        <!-- updates blurb added by Sam Hokin -->
        ...
        <div id="low">
            ...
            <div id="api">
              ...
              <ul id="api-langs">
                  <li><a href="<c:out value="${WEB_PROPERTIES['path']}" />api.do?subtab=perl">Perl</a></li>
                  <li><a href="<c:out value="${WEB_PROPERTIES['path']}" />api.do?subtab=python">Python</a></li>
                  <li><a href="<c:out value="${WEB_PROPERTIES['path']}" />api.do?subtab=ruby">Ruby</a></li>
                  <li><a href="<c:out value="${WEB_PROPERTIES['path']}" />api.do?subtab=java">Java</a></li>
              </ul>
            </div>
            <div style="clear:both;"></div>
        </div>
