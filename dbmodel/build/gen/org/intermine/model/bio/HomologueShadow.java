...
public class HomologueShadow implements Homologue, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.Homologue.geneFamily
    ...
    @Override public String toString() { return "Homologue [gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", geneFamily=" + (geneFamily == null ? "null" : (geneFamily.getId() == null ? "no id" : geneFamily.getId().toString())) + ", homologue=" + (homologue == null ? "null" : (homologue.getId() == null ? "no id" : homologue.getId().toString())) + ", id=" + id + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
