...
public class TFBindingSiteShadow implements TFBindingSite, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.TFBindingSite.CRM
    protected org.intermine.model.InterMineObject CRM;
    public org.intermine.model.bio.CRM getcRM() { if (CRM instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.CRM) ((org.intermine.objectstore.proxy.ProxyReference) CRM).getObject()); }; return (org.intermine.model.bio.CRM) CRM; }
    public void setcRM(final org.intermine.model.bio.CRM CRM) { this.CRM = CRM; }
    public void proxycRM(final org.intermine.objectstore.proxy.ProxyReference CRM) { this.CRM = CRM; }
    public org.intermine.model.InterMineObject proxGetcRM() { return CRM; }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("CRM".equals(fieldName)) {
            CRM = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("CRM".equals(fieldName)) {
            return org.intermine.model.bio.CRM.class;
        }
        if ("score".equals(fieldName)) {
    ...
    public StringConstructor getoBJECT() {
        ...
        if (CRM != null) {
            sb.append("$_^rCRM$_^").append(CRM.getId());
        }
        if (score != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rCRM".equals(notXml[i])) {
                i++;
                CRM = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.CRM.class);
                i++;
            };
