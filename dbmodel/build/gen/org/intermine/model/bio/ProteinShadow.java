...
public class ProteinShadow implements Protein, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.Protein.sequenceOntologyTerm
    ...
    // Col: org.intermine.model.bio.Protein.consensusRegions
    protected java.util.Set<org.intermine.model.bio.ConsensusRegion> consensusRegions = new java.util.HashSet<org.intermine.model.bio.ConsensusRegion>();
    public java.util.Set<org.intermine.model.bio.ConsensusRegion> getConsensusRegions() { return consensusRegions; }
    public void setConsensusRegions(final java.util.Set<org.intermine.model.bio.ConsensusRegion> consensusRegions) { this.consensusRegions = consensusRegions; }
    public void addConsensusRegions(final org.intermine.model.bio.ConsensusRegion arg) { consensusRegions.add(arg); }

    // Col: org.intermine.model.bio.Protein.proteinMatches
    protected java.util.Set<org.intermine.model.bio.ProteinMatch> proteinMatches = new java.util.HashSet<org.intermine.model.bio.ProteinMatch>();
    public java.util.Set<org.intermine.model.bio.ProteinMatch> getProteinMatches() { return proteinMatches; }
    public void setProteinMatches(final java.util.Set<org.intermine.model.bio.ProteinMatch> proteinMatches) { this.proteinMatches = proteinMatches; }
    public void addProteinMatches(final org.intermine.model.bio.ProteinMatch arg) { proteinMatches.add(arg); }
    ...
    @Override public String toString() { return "Protein [chadoFeatureId=" + chadoFeatureId + ", chadoName=" + (chadoName == null ? "null" : "\"" + chadoName + "\"") + ", chadoUniqueName=" + (chadoUniqueName == null ? "null" : "\"" + chadoUniqueName + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=" + id + ", length=" + length + ", md5checksum=" + (md5checksum == null ? "null" : "\"" + md5checksum + "\"") + ", molecularWeight=" + molecularWeight + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", note=" + (note == null ? "null" : "\"" + note + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryAccession=" + (primaryAccession == null ? "null" : "\"" + primaryAccession + "\"") + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("consensusRegions".equals(fieldName)) {
            return consensusRegions;
        }
        if ("proteinMatches".equals(fieldName)) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("consensusRegions".equals(fieldName)) {
            consensusRegions = (java.util.Set) value;
        } else if ("proteinMatches".equals(fieldName)) {
            proteinMatches = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        consensusRegions = new ProxyCollection<org.intermine.model.bio.ConsensusRegion>(os, this, "consensusRegions", org.intermine.model.bio.ConsensusRegion.class);
        proteinMatches = new ProxyCollection<org.intermine.model.bio.ProteinMatch>(os, this, "proteinMatches", org.intermine.model.bio.ProteinMatch.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("CDSs".equals(fieldName)) {
            ...
            consensusRegions.add((org.intermine.model.bio.ConsensusRegion) element);
        } else if ("proteinMatches".equals(fieldName)) {
            proteinMatches.add((org.intermine.model.bio.ProteinMatch) element);
        } else if ("proteinDomains".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("proteinMatches".equals(fieldName)) {
            return org.intermine.model.bio.ProteinMatch.class;
        }
        if ("proteinDomains".equals(fieldName)) {
