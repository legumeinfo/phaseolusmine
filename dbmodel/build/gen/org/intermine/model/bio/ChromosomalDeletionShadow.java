...
public class ChromosomalDeletionShadow implements ChromosomalDeletion, ShadowClass
{
    ...
    @Override public String toString() { return "ChromosomalDeletion [chadoFeatureId=" + chadoFeatureId + ", chadoName=" + (chadoName == null ? "null" : "\"" + chadoName + "\"") + ", chadoUniqueName=" + (chadoUniqueName == null ? "null" : "\"" + chadoUniqueName + "\"") + ", id=" + id + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + "]"; }
