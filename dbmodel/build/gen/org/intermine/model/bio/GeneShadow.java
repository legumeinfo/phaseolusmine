...
public class GeneShadow implements Gene, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Gene.familyRepresentative
    protected java.lang.String familyRepresentative;
    public java.lang.String getFamilyRepresentative() { return familyRepresentative; }
    public void setFamilyRepresentative(final java.lang.String familyRepresentative) { this.familyRepresentative = familyRepresentative; }
    ...
    // Ref: org.intermine.model.bio.Gene.geneFamily
    protected org.intermine.model.InterMineObject geneFamily;
    public org.intermine.model.bio.GeneFamily getGeneFamily() { if (geneFamily instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.GeneFamily) ((org.intermine.objectstore.proxy.ProxyReference) geneFamily).getObject()); }; return (org.intermine.model.bio.GeneFamily) geneFamily; }
    public void setGeneFamily(final org.intermine.model.bio.GeneFamily geneFamily) { this.geneFamily = geneFamily; }
    public void proxyGeneFamily(final org.intermine.objectstore.proxy.ProxyReference geneFamily) { this.geneFamily = geneFamily; }
    public org.intermine.model.InterMineObject proxGetGeneFamily() { return geneFamily; }
    ...
    // Col: org.intermine.model.bio.Gene.spanningQTLs
    protected java.util.Set<org.intermine.model.bio.QTL> spanningQTLs = new java.util.HashSet<org.intermine.model.bio.QTL>();
    public java.util.Set<org.intermine.model.bio.QTL> getSpanningQTLs() { return spanningQTLs; }
    public void setSpanningQTLs(final java.util.Set<org.intermine.model.bio.QTL> spanningQTLs) { this.spanningQTLs = spanningQTLs; }
    public void addSpanningQTLs(final org.intermine.model.bio.QTL arg) { spanningQTLs.add(arg); }

    // Col: org.intermine.model.bio.Gene.expressionValues
    protected java.util.Set<org.intermine.model.bio.ExpressionValue> expressionValues = new java.util.HashSet<org.intermine.model.bio.ExpressionValue>();
    public java.util.Set<org.intermine.model.bio.ExpressionValue> getExpressionValues() { return expressionValues; }
    public void setExpressionValues(final java.util.Set<org.intermine.model.bio.ExpressionValue> expressionValues) { this.expressionValues = expressionValues; }
    public void addExpressionValues(final org.intermine.model.bio.ExpressionValue arg) { expressionValues.add(arg); }
    ...
    // Col: org.intermine.model.bio.Gene.alleles
    ...
    // Ref: org.intermine.model.bio.SequenceFeature.supercontigLocation
    protected org.intermine.model.InterMineObject supercontigLocation;
    public org.intermine.model.bio.Location getSupercontigLocation() { if (supercontigLocation instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Location) ((org.intermine.objectstore.proxy.ProxyReference) supercontigLocation).getObject()); }; return (org.intermine.model.bio.Location) supercontigLocation; }
    public void setSupercontigLocation(final org.intermine.model.bio.Location supercontigLocation) { this.supercontigLocation = supercontigLocation; }
    public void proxySupercontigLocation(final org.intermine.objectstore.proxy.ProxyReference supercontigLocation) { this.supercontigLocation = supercontigLocation; }
    public org.intermine.model.InterMineObject proxGetSupercontigLocation() { return supercontigLocation; }
    ...
    // Ref: org.intermine.model.bio.SequenceFeature.supercontig
    protected org.intermine.model.InterMineObject supercontig;
    public org.intermine.model.bio.Supercontig getSupercontig() { if (supercontig instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Supercontig) ((org.intermine.objectstore.proxy.ProxyReference) supercontig).getObject()); }; return (org.intermine.model.bio.Supercontig) supercontig; }
    public void setSupercontig(final org.intermine.model.bio.Supercontig supercontig) { this.supercontig = supercontig; }
    public void proxySupercontig(final org.intermine.objectstore.proxy.ProxyReference supercontig) { this.supercontig = supercontig; }
    public org.intermine.model.InterMineObject proxGetSupercontig() { return supercontig; }
    ...
    @Override public String toString() { return "Gene [briefDescription=" + (briefDescription == null ? "null" : "\"" + briefDescription + "\"") + ", chadoFeatureId=" + chadoFeatureId + ", chadoName=" + (chadoName == null ? "null" : "\"" + chadoName + "\"") + ", chadoUniqueName=" + (chadoUniqueName == null ? "null" : "\"" + chadoUniqueName + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", downstreamIntergenicRegion=" + (downstreamIntergenicRegion == null ? "null" : (downstreamIntergenicRegion.getId() == null ? "no id" : downstreamIntergenicRegion.getId().toString())) + ", familyRepresentative=" + (familyRepresentative == null ? "null" : "\"" + familyRepresentative + "\"") + ", geneFamily=" + (geneFamily == null ? "null" : (geneFamily.getId() == null ? "no id" : geneFamily.getId().toString())) + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", supercontig=" + (supercontig == null ? "null" : (supercontig.getId() == null ? "no id" : supercontig.getId().toString())) + ", supercontigLocation=" + (supercontigLocation == null ? "null" : (supercontigLocation.getId() == null ? "no id" : supercontigLocation.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", upstreamIntergenicRegion=" + (upstreamIntergenicRegion == null ? "null" : (upstreamIntergenicRegion.getId() == null ? "no id" : upstreamIntergenicRegion.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("familyRepresentative".equals(fieldName)) {
        ...
        if ("geneFamily".equals(fieldName)) {
            if (geneFamily instanceof ProxyReference) {
                return ((ProxyReference) geneFamily).getObject();
            } else {
                return geneFamily;
            }
        }
        ...
        if ("spanningQTLs".equals(fieldName)) {
            return spanningQTLs;
        }
        if ("expressionValues".equals(fieldName)) {
        ...
        if ("supercontigLocation".equals(fieldName)) {
            if (supercontigLocation instanceof ProxyReference) {
                return ((ProxyReference) supercontigLocation).getObject();
            } else {
                return supercontigLocation;
            }
        }
        ...
        if ("supercontig".equals(fieldName)) {
            if (supercontig instanceof ProxyReference) {
                return ((ProxyReference) supercontig).getObject();
            } else {
                return supercontig;
            }
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("familyRepresentative".equals(fieldName)) {
            familyRepresentative = (java.lang.String) value;
        ...
        } else if ("geneFamily".equals(fieldName)) {
            geneFamily = (org.intermine.model.InterMineObject) value;
        ...
        } else if ("spanningQTLs".equals(fieldName)) {
            spanningQTLs = (java.util.Set) value;
        } else if ("expressionValues".equals(fieldName)) {
            expressionValues = (java.util.Set) value;
        ...
        } else if ("supercontigLocation".equals(fieldName)) {
            supercontigLocation = (org.intermine.model.InterMineObject) value;
        } else if ("chromosomeLocation".equals(fieldName)) {
            chromosomeLocation = (org.intermine.model.InterMineObject) value;
        } else if ("supercontig".equals(fieldName)) {
            supercontig = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if ("geneFamily".equals(fieldName)) {
            return org.intermine.model.bio.GeneFamily.class;
        }
        if ("flankingRegions".equals(fieldName)) {
        ...
        if ("supercontig".equals(fieldName)) {
            return org.intermine.model.bio.Supercontig.class;
        }
        if ("sequence".equals(fieldName)) {
    ...
    public StringConstructor getoBJECT() {
        ...
        if (familyRepresentative != null) {
            sb.append("$_^afamilyRepresentative$_^");
            String string = familyRepresentative;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (geneFamily != null) {
            sb.append("$_^rgeneFamily$_^").append(geneFamily.getId());
        }
        if (score != null) {
        ...
        if (supercontigLocation != null) {
            sb.append("$_^rsupercontigLocation$_^").append(supercontigLocation.getId());
        }
        if (chromosomeLocation != null) {
            sb.append("$_^rchromosomeLocation$_^").append(chromosomeLocation.getId());
        }
        if (supercontig != null) {
            sb.append("$_^rsupercontig$_^").append(supercontig.getId());
        }
        if (sequence != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "afamilyRepresentative".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                familyRepresentative = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) &&"rgeneFamily".equals(notXml[i])) {
                i++;
                geneFamily = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.GeneFamily.class);
                i++;
            };
            ...
            if ((i < notXml.length) &&"rsupercontigLocation".equals(notXml[i])) {
                i++;
                supercontigLocation = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Location.class);
                i++;
            };
            ...
            if ((i < notXml.length) &&"rsupercontig".equals(notXml[i])) {
                i++;
                supercontig = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Supercontig.class);
                i++;
            };
        ...
        spanningQTLs = new ProxyCollection<org.intermine.model.bio.QTL>(os, this, "spanningQTLs", org.intermine.model.bio.QTL.class);
        expressionValues = new ProxyCollection<org.intermine.model.bio.ExpressionValue>(os, this, "expressionValues", org.intermine.model.bio.ExpressionValue.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("flankingRegions".equals(fieldName)) {
            ...
            spanningQTLs.add((org.intermine.model.bio.QTL) element);
        } else if ("expressionValues".equals(fieldName)) {
            expressionValues.add((org.intermine.model.bio.ExpressionValue) element);
        } else if ("pathways".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("expressionValues".equals(fieldName)) {
            return org.intermine.model.bio.ExpressionValue.class;
        }
        if ("pathways".equals(fieldName)) {
