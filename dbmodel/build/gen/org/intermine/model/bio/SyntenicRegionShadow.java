...
public class SyntenicRegionShadow implements SyntenicRegion, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.SyntenicRegion.syntenyBlock
    protected org.intermine.model.InterMineObject syntenyBlock;
    public org.intermine.model.bio.SyntenyBlock getSyntenyBlock() { if (syntenyBlock instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.SyntenyBlock) ((org.intermine.objectstore.proxy.ProxyReference) syntenyBlock).getObject()); }; return (org.intermine.model.bio.SyntenyBlock) syntenyBlock; }
    public void setSyntenyBlock(final org.intermine.model.bio.SyntenyBlock syntenyBlock) { this.syntenyBlock = syntenyBlock; }
    public void proxySyntenyBlock(final org.intermine.objectstore.proxy.ProxyReference syntenyBlock) { this.syntenyBlock = syntenyBlock; }
    public org.intermine.model.InterMineObject proxGetSyntenyBlock() { return syntenyBlock; }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.SyntenicRegion.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("syntenyBlock".equals(fieldName)) {
            syntenyBlock = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("syntenyBlock".equals(fieldName)) {
            return org.intermine.model.bio.SyntenyBlock.class;
        }
        if ("score".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.SyntenicRegion.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.SyntenicRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.SyntenicRegionShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.SyntenicRegion");
        if (syntenyBlock != null) {
            sb.append("$_^rsyntenyBlock$_^").append(syntenyBlock.getId());
        }
        if (score != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rsyntenyBlock".equals(notXml[i])) {
                i++;
                syntenyBlock = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.SyntenyBlock.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.SyntenicRegion.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.SyntenicRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
