...
public class OrganismShadow implements Organism, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Organism.variety
    protected java.lang.String variety;
    public java.lang.String getVariety() { return variety; }
    public void setVariety(final java.lang.String variety) { this.variety = variety; }

    // Attr: org.intermine.model.bio.Organism.description
    protected java.lang.String description;
    public java.lang.String getDescription() { return description; }
    public void setDescription(final java.lang.String description) { this.description = description; }

    // Attr: org.intermine.model.bio.Organism.chadoId
    protected java.lang.Integer chadoId;
    public java.lang.Integer getChadoId() { return chadoId; }
    public void setChadoId(final java.lang.Integer chadoId) { this.chadoId = chadoId; }
    ...
    protected java.lang.String taxonId;
    public java.lang.String getTaxonId() { return taxonId; }
    public void setTaxonId(final java.lang.String taxonId) { this.taxonId = taxonId; }
    ...
    @Override public String toString() { return "Organism [chadoId=" + chadoId + ", commonName=" + (commonName == null ? "null" : "\"" + commonName + "\"") + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", genus=" + (genus == null ? "null" : "\"" + genus + "\"") + ", id=" + id + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", shortName=" + (shortName == null ? "null" : "\"" + shortName + "\"") + ", species=" + (species == null ? "null" : "\"" + species + "\"") + ", taxonId=" + (taxonId == null ? "null" : "\"" + taxonId + "\"") + ", variety=" + (variety == null ? "null" : "\"" + variety + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("variety".equals(fieldName)) {
            return variety;
        }
        if ("description".equals(fieldName)) {
            return description;
        }
        if ("chadoId".equals(fieldName)) {
            return chadoId;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("variety".equals(fieldName)) {
            variety = (java.lang.String) value;
        } else if ("description".equals(fieldName)) {
            description = (java.lang.String) value;
        } else if ("chadoId".equals(fieldName)) {
            chadoId = (java.lang.Integer) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (variety != null) {
            sb.append("$_^avariety$_^");
            String string = variety;
            while (string != null) {
        ...
        if (chadoId != null) {
            sb.append("$_^achadoId$_^").append(chadoId);
        }
        if (species != null) {
        ...
        if (taxonId != null) {
            sb.append("$_^ataxonId$_^");
            String string = taxonId;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "avariety".equals(notXml[i])) {
                i++;
                ...
                variety = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "achadoId".equals(notXml[i])) {
                i++;
                chadoId = Integer.valueOf(notXml[i]);
                i++;
            }
            ...
            if ((i < notXml.length) && "ataxonId".equals(notXml[i])) {
                ...
                taxonId = string == null ? notXml[i] : string.toString();
                i++;
            }
