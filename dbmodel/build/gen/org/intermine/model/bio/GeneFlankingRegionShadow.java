...
public class GeneFlankingRegionShadow implements GeneFlankingRegion, ShadowClass
{
    ...
    public java.lang.String getDirection() { return direction; }
    public void setDirection(final java.lang.String direction) { this.direction = direction; }
    ...
    // Ref: org.intermine.model.bio.GeneFlankingRegion.gene
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.GeneFlankingRegion.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.GeneFlankingRegion.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.GeneFlankingRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.GeneFlankingRegionShadow.class.equals(getClass())) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.GeneFlankingRegionShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.GeneFlankingRegion)");
        }
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "adirection".equals(notXml[i])) {
                ...
                direction = string == null ? notXml[i] : string.toString();
                i++;
            }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.GeneFlankingRegion.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.GeneFlankingRegion.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
