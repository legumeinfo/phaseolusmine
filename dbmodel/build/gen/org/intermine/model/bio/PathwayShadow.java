...
public class PathwayShadow implements Pathway, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Pathway.species
    ...
    @Override public String toString() { return "Pathway [id=" + id + ", identifier=" + (identifier == null ? "null" : "\"" + identifier + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", species=" + (species == null ? "null" : "\"" + species + "\"") + "]"; }
