...
public class GeneticMarkerShadow implements GeneticMarker, ShadowClass
{
    public static final Class<GeneticMarker> shadowOf = GeneticMarker.class;
    // Attr: org.intermine.model.bio.GeneticMarker.description
    protected java.lang.String description;
    public java.lang.String getDescription() { return description; }
    public void setDescription(final java.lang.String description) { this.description = description; }

    // Attr: org.intermine.model.bio.GeneticMarker.sourceDescription
    protected java.lang.String sourceDescription;
    public java.lang.String getSourceDescription() { return sourceDescription; }
    public void setSourceDescription(final java.lang.String sourceDescription) { this.sourceDescription = sourceDescription; }

    // Attr: org.intermine.model.bio.GeneticMarker.type
    protected java.lang.String type;
    public java.lang.String getType() { return type; }
    public void setType(final java.lang.String type) { this.type = type; }

    // Attr: org.intermine.model.bio.GeneticMarker.canonicalMarker
    protected java.lang.String canonicalMarker;
    public java.lang.String getCanonicalMarker() { return canonicalMarker; }
    public void setCanonicalMarker(final java.lang.String canonicalMarker) { this.canonicalMarker = canonicalMarker; }

    // Col: org.intermine.model.bio.GeneticMarker.QTLs
    ...
    // Col: org.intermine.model.bio.GeneticMarker.linkageGroupPositions
    protected java.util.Set<org.intermine.model.bio.LinkageGroupPosition> linkageGroupPositions = new java.util.HashSet<org.intermine.model.bio.LinkageGroupPosition>();
    public java.util.Set<org.intermine.model.bio.LinkageGroupPosition> getLinkageGroupPositions() { return linkageGroupPositions; }
    public void setLinkageGroupPositions(final java.util.Set<org.intermine.model.bio.LinkageGroupPosition> linkageGroupPositions) { this.linkageGroupPositions = linkageGroupPositions; }
    public void addLinkageGroupPositions(final org.intermine.model.bio.LinkageGroupPosition arg) { linkageGroupPositions.add(arg); }
    ...
    @Override public boolean equals(Object o) { return (o instanceof GeneticMarker && id != null) ? id.equals(((GeneticMarker)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "GeneticMarker [canonicalMarker=" + (canonicalMarker == null ? "null" : "\"" + canonicalMarker + "\"") + ", chadoFeatureId=" + chadoFeatureId + ", chadoName=" + (chadoName == null ? "null" : "\"" + chadoName + "\"") + ", chadoUniqueName=" + (chadoUniqueName == null ? "null" : "\"" + chadoUniqueName + "\"") + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", sourceDescription=" + (sourceDescription == null ? "null" : "\"" + sourceDescription + "\"") + ", supercontig=" + (supercontig == null ? "null" : (supercontig.getId() == null ? "no id" : supercontig.getId().toString())) + ", supercontigLocation=" + (supercontigLocation == null ? "null" : (supercontigLocation.getId() == null ? "no id" : supercontigLocation.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("description".equals(fieldName)) {
            return description;
        }
        if ("sourceDescription".equals(fieldName)) {
            return sourceDescription;
        }
        if ("type".equals(fieldName)) {
            return type;
        }
        if ("canonicalMarker".equals(fieldName)) {
            return canonicalMarker;
        }
        if ("QTLs".equals(fieldName)) {
            return QTLs;
        }
        if ("linkageGroupPositions".equals(fieldName)) {
            return linkageGroupPositions;
        }
        ...
        if (!org.intermine.model.bio.GeneticMarker.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("sourceDescription".equals(fieldName)) {
            sourceDescription = (java.lang.String) value;
        } else if ("type".equals(fieldName)) {
            type = (java.lang.String) value;
        } else if ("canonicalMarker".equals(fieldName)) {
            canonicalMarker = (java.lang.String) value;
        } else if ("QTLs".equals(fieldName)) {
            QTLs = (java.util.Set) value;
        } else if ("linkageGroupPositions".equals(fieldName)) {
            linkageGroupPositions = (java.util.Set) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.GeneticMarker.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.GeneticMarker.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.GeneticMarkerShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.GeneticMarker");
        if (description != null) {
        ...
        if (sourceDescription != null) {
            sb.append("$_^asourceDescription$_^");
            String string = sourceDescription;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (canonicalMarker != null) {
            sb.append("$_^acanonicalMarker$_^");
            String string = canonicalMarker;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.GeneticMarkerShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.GeneticMarker)");
        }
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "asourceDescription".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                sourceDescription = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "acanonicalMarker".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                canonicalMarker = string == null ? notXml[i] : string.toString();
                i++;
            }
        ...
        linkageGroupPositions = new ProxyCollection<org.intermine.model.bio.LinkageGroupPosition>(os, this, "linkageGroupPositions", org.intermine.model.bio.LinkageGroupPosition.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("QTLs".equals(fieldName)) {
            ...
            linkageGroupPositions.add((org.intermine.model.bio.LinkageGroupPosition) element);
        } else if ("overlappingFeatures".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("linkageGroupPositions".equals(fieldName)) {
            return org.intermine.model.bio.LinkageGroupPosition.class;
        }
        if ("overlappingFeatures".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.GeneticMarker.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.GeneticMarker.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
