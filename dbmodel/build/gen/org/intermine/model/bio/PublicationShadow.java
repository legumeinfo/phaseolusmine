...
public class PublicationShadow implements Publication, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Publication.lastAuthor
    protected java.lang.String lastAuthor;
    public java.lang.String getLastAuthor() { return lastAuthor; }
    public void setLastAuthor(final java.lang.String lastAuthor) { this.lastAuthor = lastAuthor; }
    ...
    @Override public String toString() { return "Publication [abstractText=" + (abstractText == null ? "null" : "\"" + abstractText + "\"") + ", doi=" + (doi == null ? "null" : "\"" + doi + "\"") + ", firstAuthor=" + (firstAuthor == null ? "null" : "\"" + firstAuthor + "\"") + ", id=" + id + ", issue=" + (issue == null ? "null" : "\"" + issue + "\"") + ", journal=" + (journal == null ? "null" : "\"" + journal + "\"") + ", lastAuthor=" + (lastAuthor == null ? "null" : "\"" + lastAuthor + "\"") + ", month=" + (month == null ? "null" : "\"" + month + "\"") + ", pages=" + (pages == null ? "null" : "\"" + pages + "\"") + ", pubMedId=" + (pubMedId == null ? "null" : "\"" + pubMedId + "\"") + ", title=" + (title == null ? "null" : "\"" + title + "\"") + ", volume=" + (volume == null ? "null" : "\"" + volume + "\"") + ", year=" + year + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("lastAuthor".equals(fieldName)) {
            return lastAuthor;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("lastAuthor".equals(fieldName)) {
            lastAuthor = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (lastAuthor != null) {
            sb.append("$_^alastAuthor$_^");
            String string = lastAuthor;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "alastAuthor".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                lastAuthor = string == null ? notXml[i] : string.toString();
                i++;
            }
