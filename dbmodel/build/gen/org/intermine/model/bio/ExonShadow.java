...
public class ExonShadow implements Exon, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.Exon.MRNA
    protected org.intermine.model.InterMineObject MRNA;
    public org.intermine.model.bio.MRNA getmRNA() { if (MRNA instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.MRNA) ((org.intermine.objectstore.proxy.ProxyReference) MRNA).getObject()); }; return (org.intermine.model.bio.MRNA) MRNA; }
    public void setmRNA(final org.intermine.model.bio.MRNA MRNA) { this.MRNA = MRNA; }
    public void proxymRNA(final org.intermine.objectstore.proxy.ProxyReference MRNA) { this.MRNA = MRNA; }
    public org.intermine.model.InterMineObject proxGetmRNA() { return MRNA; }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("MRNA".equals(fieldName)) {
            if (MRNA instanceof ProxyReference) {
                return ((ProxyReference) MRNA).getObject();
            } else {
                return MRNA;
            }
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("MRNA".equals(fieldName)) {
            MRNA = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if ("MRNA".equals(fieldName)) {
            return org.intermine.model.bio.MRNA.class;
        }
        if ("transcripts".equals(fieldName)) {
    ...
    public StringConstructor getoBJECT() {
        ...
        if (MRNA != null) {
            sb.append("$_^rMRNA$_^").append(MRNA.getId());
        }
        if (score != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) &&"rMRNA".equals(notXml[i])) {
                i++;
                MRNA = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.MRNA.class);
                i++;
            };
