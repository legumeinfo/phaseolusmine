...
public class ProteinDomainShadow implements ProteinDomain, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.ProteinDomain.interproShortName
    protected java.lang.String interproShortName;
    public java.lang.String getInterproShortName() { return interproShortName; }
    public void setInterproShortName(final java.lang.String interproShortName) { this.interproShortName = interproShortName; }

    // Attr: org.intermine.model.bio.ProteinDomain.interproId
    protected java.lang.String interproId;
    public java.lang.String getInterproId() { return interproId; }
    public void setInterproId(final java.lang.String interproId) { this.interproId = interproId; }

    // Attr: org.intermine.model.bio.ProteinDomain.interproName
    protected java.lang.String interproName;
    public java.lang.String getInterproName() { return interproName; }
    public void setInterproName(final java.lang.String interproName) { this.interproName = interproName; }

    // Ref: org.intermine.model.bio.ProteinDomain.sequenceOntologyTerm
    ...
    // Col: org.intermine.model.bio.ProteinDomain.proteinHmmMatches
    protected java.util.Set<org.intermine.model.bio.ProteinHmmMatch> proteinHmmMatches = new java.util.HashSet<org.intermine.model.bio.ProteinHmmMatch>();
    public java.util.Set<org.intermine.model.bio.ProteinHmmMatch> getProteinHmmMatches() { return proteinHmmMatches; }
    public void setProteinHmmMatches(final java.util.Set<org.intermine.model.bio.ProteinHmmMatch> proteinHmmMatches) { this.proteinHmmMatches = proteinHmmMatches; }
    public void addProteinHmmMatches(final org.intermine.model.bio.ProteinHmmMatch arg) { proteinHmmMatches.add(arg); }
    ...
    @Override public String toString() { return "ProteinDomain [chadoFeatureId=" + chadoFeatureId + ", chadoName=" + (chadoName == null ? "null" : "\"" + chadoName + "\"") + ", chadoUniqueName=" + (chadoUniqueName == null ? "null" : "\"" + chadoUniqueName + "\"") + ", id=" + id + ", interproId=" + (interproId == null ? "null" : "\"" + interproId + "\"") + ", interproName=" + (interproName == null ? "null" : "\"" + interproName + "\"") + ", interproShortName=" + (interproShortName == null ? "null" : "\"" + interproShortName + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("interproShortName".equals(fieldName)) {
            return interproShortName;
        }
        if ("interproId".equals(fieldName)) {
            return interproId;
        }
        if ("interproName".equals(fieldName)) {
            return interproName;
        }
        ...
        if ("proteinHmmMatches".equals(fieldName)) {
            return proteinHmmMatches;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("interproShortName".equals(fieldName)) {
            interproShortName = (java.lang.String) value;
        } else if ("interproId".equals(fieldName)) {
            interproId = (java.lang.String) value;
        } else if ("interproName".equals(fieldName)) {
            interproName = (java.lang.String) value;
        ...
        } else if ("proteinHmmMatches".equals(fieldName)) {
            proteinHmmMatches = (java.util.Set) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (interproShortName != null) {
            sb.append("$_^ainterproShortName$_^");
            String string = interproShortName;
            while (string != null) {
        ...
        if (interproId != null) {
            sb.append("$_^ainterproId$_^");
            String string = interproId;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (interproName != null) {
            sb.append("$_^ainterproName$_^");
            String string = interproName;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "ainterproShortName".equals(notXml[i])) {
                i++;
                ...
                interproShortName = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "ainterproId".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                interproId = string == null ? notXml[i] : string.toString();
                i++;
            }
            if ((i < notXml.length) && "ainterproName".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                interproName = string == null ? notXml[i] : string.toString();
                i++;
            }
        ...
        proteinHmmMatches = new ProxyCollection<org.intermine.model.bio.ProteinHmmMatch>(os, this, "proteinHmmMatches", org.intermine.model.bio.ProteinHmmMatch.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("proteins".equals(fieldName)) {
            ...
            proteinHmmMatches.add((org.intermine.model.bio.ProteinHmmMatch) element);
        } else if ("locations".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("proteinHmmMatches".equals(fieldName)) {
            return org.intermine.model.bio.ProteinHmmMatch.class;
        }
        if ("locations".equals(fieldName)) {
